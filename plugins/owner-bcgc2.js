const handler = async (m, {conn, text, participants, isAdmin, isOwner, usedPrefix, command}) => {
  ...
  const fproducto = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? {remoteJid: '17608914335@s.whatsapp.net'} : {})}, message: {'productMessage': {'product': {'productImage': {'mimetype': 'image/jpeg', 'jpegThumbnail': imagen1}, 'title': `𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗔 𝗠𝗮𝗻𝗱𝗮𝗱𝗼 𝗨𝗻 𝗖𝗼𝗺𝘂𝗻𝗶𝗰𝗮𝗱𝗼 𝗢𝗳𝗶𝗰𝗶𝗮𝗹 𝗔 𝗧𝗼𝗱𝗼𝘀 𝗦𝘂𝘀 𝗣𝗲𝗿𝗿@𝘀`, 'description': '〔 𝗢𝗽𝘁𝗶𝗺𝘂𝘀 𝗕𝗼𝘁 〕', 'currencyCode': 'USD', 'priceAmount1000': '1000000000', 'retailerId': 'Ghost', 'productImageCount': 1}, 'businessOwnerJid': `0@s.whatsapp.net`}}};
